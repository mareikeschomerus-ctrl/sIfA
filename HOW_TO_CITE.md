...
> Figure X. Statement of Intellectual Fellowship and Accountability (sIfA) for this work, generated with the sIfA Tool v1.1 (Schomerus, 2026). The orange field represents human contribution; the inner purple shape represents AI contribution; each axis is one CRediT contributor role.
